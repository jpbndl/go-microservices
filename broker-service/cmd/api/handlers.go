...
type RequestPayload struct {
	...
	Auth   AuhtPayload `json:"auth,omitempty"`
	Log    LogPayload  `json:"log,omitempty"`
	Mail   MailPayload `json:"mail,omitempty"`
}

type AuhtPayload struct {
...
func (app *Config) authenticate(w http.ResponseWriter, a AuhtPayload) {
...
func (app *Config) logItemViaRPC(w http.ResponseWriter, l LogPayload) {
	client, err := rpc.Dial("tcp", "logger-service:4300")
	if err != nil {
		app.errorJSON(w, err)
		return
	}
...
func (app *Config) logViaGRPC(w http.ResponseWriter, r *http.Request) {
	...
	conn, err := grpc.Dial("logger-service:4400", grpc.WithTransportCredentials(insecure.NewCredentials()))
	if err != nil {
		app.errorJSON(w, err)
		return
	}
